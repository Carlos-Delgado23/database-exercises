...
VALUES ('Michael Jackson',   'Thriller',                               1982, 47.3, 'Pop, post-disco, funk and rock'),
       ...
       ('Eagles',            'Their Greatest Hits',                    1976, 41.2, 'Country rock, soft rock, folk ' ||
        'rock'),
       ...
       ('Michael Jackson',   'Bad',                                    1987, 22.2, 'Pop, rhythm and blues, funk and ' ||
        'rock'),
       ...
       ('James Horner',      'Titanic: Music from the Motion',         1997, 18.1, 'Film score'),
