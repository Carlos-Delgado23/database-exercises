...
SELECT COUNT(*) AS 'Number of students that have taken test' FROM (
SELECT DISTINCT users_id, COUNT(*)
FROM results
JOIN quizzes AS q on results.quizzes_id = q.id AND q.id = 5) as userCount;